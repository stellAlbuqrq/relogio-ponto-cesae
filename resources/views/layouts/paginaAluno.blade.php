...
<body>
    <header>
        <nav>
            ...
            {{-- Sidebar --}}
            <div
                class="relative flex h-full w-full max-w-[20rem] flex-col bg-clip-border p-4 text-[#EAEAEA] shadow-xl shadow-blue-gray-300/5 font-['Nunito Sans'] bg-[#190E40]">

                {{-- Logo e Título --}}
                <div class="container flex flex-wrap items-center justify-center p-4 mb-2">
                    <a href="/"> <img src="{{ asset('imagens/cesae-digital-pb.png') }}" alt="Logo Principal" class="h-16 w-auto"></a>
                </div>
                    <div class="mb-4">
                    <h5
                        class="block text-xl antialiased font-bold leading-snug tracking-normal text-center">
                    ...
                    <div class="relative block w-full">
                        ...
                        <div class="overflow-hidden">
                            <div
                                class="block w-full py-1 font-sans text-sm antialiased font-light leading-normal text-[#EAEAEA]">
                                <nav
