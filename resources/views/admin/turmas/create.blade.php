    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50">
        <div class="relative flex w-full max-w-[48rem] flex-col rounded-lg bg-white border border-slate-200 shadow-sm">
            <div class="relative flex flex-col items-center justify-center text-white h-28 rounded-md bg-[#40155E]">
                <h5 class="text-white text-3xl font-bold">Criar nova Turma</h5>
            </div>
            <div class="p-6">
                <div class="block overflow-visible">
                    ...
                    {{-- Formulário --}}
                    <form action="{{ route('admin.turmas.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        {{-- Data Início --}}
                        <label for="data_inicio" class="block text-lg text-[#40155E] font-bold mb-2 mt-5">Data de Início</label>
