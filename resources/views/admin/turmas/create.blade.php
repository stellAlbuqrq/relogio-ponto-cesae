...
<div class="w-full max-w-xl p-6 mx-auto">
    <h1 class="text-xl font-bold mb-4">Criar Nova Turma</h1>
    ...
    <form action="{{ route('admin.turmas.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nome" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('nome') }}" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="date" name="data_inicio" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('data_inicio') }}" required>
        </div>

        <div class="mb-4">
            <label class="block text-sm font-semibold mb-1">Data de Fim</label>
            <input type="date" name="data_fim" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('data_fim') }}" required>
        </div>

        <div class="mt-6">
            <button type="submit" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded">Criar Turma</button>
