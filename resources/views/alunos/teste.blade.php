...
@section('content')
    <div class="max-w-md mx-auto p-8 bg-white rounded-md shadow-md">
        ...
        <form action="#" method="POST">
            <div class="mb-4">
                <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Hora</label>
                <label for="hora_agora" class="flex items-center space-x-2 px-3 py-2 text-gray-700">11:36</label>
            </div>
            <div class="mb-4">
                <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Data</label>
                <label for="data_hoje" class="flex items-center space-x-2 px-3 py-2 text-gray-700">26/05/2025</label>
            </div>
            <div class="mb-4">
